#!/bin/bash
# source: https://gist.github.com/mustafaturan/7053900
# added new versions
...
## changed opus version
cd ~/ffmpeg_sources
curl -O http://opus-codec.org/release/stable/2017/06/26/libopus-1_2_1.html
...
cd ~/ffmpeg_sources
curl -O https://ftp.osuosl.org/pub/xiph/releases/theora/libtheora-1.1.1.tar.gz
tar xzvf libtheora-1.1.1.tar.gz
cd libtheora-1.1.1
./configure --prefix="$HOME/ffmpeg_build" --with-ogg="$HOME/ffmpeg_build" --disable-examples --disable-shared --disable-sdltest --disable-vorbistest --disable-unit-tests
make
make install
make distclean
